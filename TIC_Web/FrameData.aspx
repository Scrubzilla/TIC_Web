...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>Frame Data</h2>
    <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/CharacterSelect.aspx" CssClass="custFontColor">Back to character select</asp:LinkButton>
    <br />
    <br />
    <asp:Panel ID="Panel1" runat="server" DefaultButton="Button1">
                ...
                <asp:TextBox ID="searchField" runat="server" KeyDown="SearchFieldKeyDown"></asp:TextBox>
                <br />
